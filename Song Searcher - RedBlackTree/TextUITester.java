...
//# For Backend Developer Tests
//        runBDTests: Backend.class SingleSong.class BackendDeveloperTests.class
...
//
//        IterableMultiKeySortedCollectionPlaceholder.class: IterableMultiKeySortedCollectionPlaceholder.java
//        javac IterableMultiKeySortedCollectionPlaceholder.java
//
//
//        # For Frontend Developer Tests
//        runFDTests: Frontend.class TextUITester.class FrontendDeveloperTests.class
//java -jar ../junit5.jar --class-path=. --select-class=FrontendDeveloperTests
//
//        Frontend.class: Frontend.java FrontendInterface.java BackendPlaceholderHenry.class SongData.class
//javac Frontend.java
//
//        FrontendDeveloperTests.class: FrontendDeveloperTests.java TextUITester.class Frontend.class
...
//
//
//        # For individual class compilation
//BackendInterface.class: BackendInterface.java
//        javac BackendInterface.java
//
//        BackendPlaceholderHenry.class: BackendPlaceholderHenry.java
//        javac BackendPlaceholderHenry.java
//
//        BinarySearchTree.class: BinarySearchTree.java
//        javac BinarySearchTree.java
//
//        IndividualBackendInterface.class: IndividualBackendInterface.java
//        javac IndividualBackendInterface.java
//
//        IterableMultiKeyRBT.class: IterableMultiKeyRBT.java
//        javac IterableMultiKeyRBT.java
//
//        IterableMultiKeySortedCollectionInterface.class: IterableMultiKeySortedCollectionInterface.java
//        javac IterableMultiKeySortedCollectionInterface.java
//
//        KeyList.class: KeyList.java KeyListInterface.java
//        javac KeyList.java
//
...
//
//        SongData.class: SongData.java SongDataInterface.java
//        javac SongData.java
//
//        SongDataInterface.class: SongDataInterface.java
//        javac SongDataInterface.java
//
